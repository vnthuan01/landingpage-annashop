        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "4rem" }} className="md:grid-cols-2">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem" }}>
            {aboutContent.values.map((item, i) => {
              const icons = {
                mission: <><circle cx="12" cy="12" r="10" /><path d="M8 12l3 3 5-6" /></>,
                vision: <><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" /><circle cx="12" cy="12" r="3" /></>,
                core_values: <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />,
              };
