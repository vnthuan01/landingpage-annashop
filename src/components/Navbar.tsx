    ...
    <>
      <nav style={navStyle}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", flexShrink: 0 }}>
          ...
          <button onClick={onCartClick} className="relative" style={{ padding: "0.625rem", color: "var(--color-muted)", cursor: "pointer", background: "none", border: "none", transition: "color 0.3s" }} aria-label="Giỏ hàng">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      {/* Mobile Menu */}
      {mobileOpen && (
        <div style={{ position: "fixed", top: "6rem", left: "50%", transform: "translateX(-50%)", zIndex: 99, width: "min(90%, 400px)", padding: "2rem", borderRadius: "1.5rem", background: "rgba(10,10,10,0.95)", backdropFilter: "blur(24px)", border: "1px solid rgba(255,255,255,0.06)" }} className="animate-fade-in">
